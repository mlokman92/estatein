...
// Navigation routes are fixed and drive active-state logic, so they stay in code.
const NAV_LINKS = [
  { label: "Home", href: "/" },
...
export function HeaderClient({ banner }: { banner: BannerContent | null }) {
  ...
  const bannerText = banner?.text ?? "Discover Your Dream Property with Estatein";
